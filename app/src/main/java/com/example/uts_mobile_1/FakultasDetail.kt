...
class FakultasDetail : AppCompatActivity() {
    ...
    val listdatalink = arrayOf(
        ...
        "https://github.com/helmykurniawan1313" //7
    )

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.detail_fakultas)
        var emailfk = findViewById<TextView>(R.id.email)
        ...
        if (intentThatStartedThisActivity.hasExtra(Intent.EXTRA_TEXT)) {
            ...
            var email = intentThatStartedThisActivity.getStringExtra("email")
