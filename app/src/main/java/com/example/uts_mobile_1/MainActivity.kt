...
class MainActivity : AppCompatActivity() {
    ...
    private fun fakItemClicked (fakItem : Fakultas) {
        ...
        showDetailActivityIntent.putExtra("email",fakItem.email)
    ...
    private fun deskripsiFakultas(): List<Fakultas> {
        ...
        fakList.add(
            Fakultas(R.drawable.feb, "Fakultas Ekonomi dan Bisnis",
        ...
        fakList.add(
            Fakultas(R.drawable.faperta, "Fakultas Pertanian",
        ...
        fakList.add(
            Fakultas(R.drawable.ft, "Fakultas Teknik",
        ...
        fakList.add(
            Fakultas(R.drawable.fisip, "Fakultas Ilmu Sosial dan Politik",
        ...
        fakList.add(
            Fakultas(R.drawable.fik, "Fakultas Ilmu Komputer",
        ...
        fakList.add(
            Fakultas(R.drawable.fad, "Fakultas Arsitektur & Desain",
        ...
        fakList.add(
            Fakultas(R.drawable.fh, "Fakultas Hukum",
        ...
        fakList.add(
            Fakultas(R.drawable.eis, "Profile",
                "NAMA       \n" +
                        "Helmy Kurniawan\n" +
                        "\nTTL       \n" +
                        "Surabaya, 1 September 1999\n" +
                        "\nALAMAT     \n" +
                        "Jl. Jalan Wonoayu No.138A Rungkut\n" +
                        "\nEMAIL   \n" +
                        "helmykurniawan1313@gmail.com\n" +
                        "\nPENDIDIKAN \n" +
                        "  - SDN Medokan Ayu 1/270\n" +
                        "  - SMPN 35 Surabaya\n" +
                        "  - SMKN 10 Surabaya\n" +
                        "\nPENGHARGAAN  \n" +
                        "\nURL GITHUB" ,
                "https://github.com/helmykurniawan1313\n",
                "helmykurniawan1313@gmail.com"
            )
        )
